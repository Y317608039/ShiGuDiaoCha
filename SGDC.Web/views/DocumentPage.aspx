...
<form id="sgdocumentr_edit" style="margin: 0; padding: 5px 0 0 25px; color: #333;">
    ...
    <table>
        ...
        <tr>
            <td>文档内容：</td>
            <td>
                <input type="text" id="docdesc" name="docdesc" class="easyui-validatebox textbox" style="width: 200px; height: 60px;"></td>
        </tr>
        <tr>
            <td>信息扩展1：</td>
            <td>
