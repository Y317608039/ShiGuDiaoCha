...
<table class="tableprintable" border="1" cellSpacing="0" borderColor="#000000"
       width="100%">
<tbody>
<tr>
    ...
    <td class="tdprintabtop" rowSpan="2" width="5%"
        align="middle">
        <NOBR>地点</NOBR>
    </td>
...
<table border="1" cellSpacing="0" borderColor="#000000" cellPadding="1"  width="99%">
    ...
    <tr class="VwCtr">
        ...
        <td id="bgfjtd" width="30%">
            ...
            <A href="javascript:downLoadFj('1F1F3EBE73C7622EE0530A6A0267622E')">
                “8.2”陇海线较大铁路交通事故调查报告.pdf
            </A>
        </td>
        <td width="15%" align="middle">
            现场调查有关资料<FONT id="xcdcfjFont" color="red"> </FONT>
        </td>
        <td id="xcdcfjtd" width="30%"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_XianChangDiaoChaZiLiao" name="txtZR_XianChangDiaoChaZiLiao" /> </td>
    </tr>
    <tr>
        <td width="10%" align="middle">
            损失计算材料<FONT id="ssjsfjFont" color="red"></FONT>
        </td>
        <td id="ssjsfjtd" width="30%"> <input type="text" style="FONT-SIZE: 9pt" id="txtZR_SunShiDiaoChaZiLiao" name="txtZR_SunShiDiaoChaZiLiao" /></td>
        <td width="15%" align="middle">
        ...
        <td id="sgrdsfjtd" width="30%">
            ...
            <A href="javascript:downLoadFj('1F1F3EBE73C8622EE0530A6A0267622E')">
                “8.2”陇海线较大事故认定书.pdf
            </A>
        </td>
    </tr>
    <tr style="HEIGHT: 20px">
        ...
        <td id="ajb2fjtd" width="30%"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_AnJianBaoEr" name="txtZR_AnJianBaoEr" /></td>
        <td width="10%" align="middle">其它</td>
        <td id="qtfjtd" width="30%"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_QiTa" name="txtZR_QiTa" /> </td>
    </tr>
    <tr style="HEIGHT: 20px">
        <td width="10%" align="middle">特派办调查报告</td>
        <td id="td3" width="30%"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_TePaiBanDiaoChaBaoGao" name="txtZR_TePaiBanDiaoChaBaoGao" /> </td>
        <td width="10%" align="middle">深度调查报告</td>
        <td id="td4" width="30%"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_SheDuDiaoChaBaoGao" name="txtZR_SheDuDiaoChaBaoGao" /> </td>
    </tr>
    <tr>
        <td colSpan="4" align="middle"><input type="text" style="FONT-SIZE: 9pt" id="txtZR_last" name="txtZR_last" /> </td>
    </tr>
    </tbody>
</table>
